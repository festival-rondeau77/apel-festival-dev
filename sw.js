...
const VERSION = '2026.09.24-418cb74';
const CACHE_APPLI = `festival-appli-${VERSION}`;
const CACHE_DONNEES = 'festival-donnees';
const FICHIERS = [
  './', './index.html', './styles.css', './manifest.webmanifest',
  './js/app.js', './js/erreurs.js', './js/config.js', './js/donnees.js', './js/empreinte.js', './js/visite.js', './js/stats.js', './js/sources.js', './js/routes.js', './js/rendu.js', './js/plan.js', './js/batiment.js', './js/icones.js', './js/defis.js', './js/passeport.js',
