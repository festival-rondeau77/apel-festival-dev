...
export default [
  ...
  // instants gagnants (grand-defi 08)
  "Instant gagnant", "Une question, un lot à gagner", "Ce défi n’est pas un instant gagnant.", "Cet instant gagnant n’a pas encore commencé.", "Répondez avant %s : un gagnant est tiré parmi les bonnes réponses.", "Réponse enregistrée : %s", "Tirage vers %s parmi les bonnes réponses : si vous gagnez, l’appli vous le dit.", "Réponse arrivée trop tard : l’instant était fermé.", "Cet instant gagnant est fermé.", "Venez à l’accueil avant %s.", "Encore %s minute", "Encore %s minutes", "Venez à l’accueil pour le retirer.", "Délai dépassé : le lot est remis en jeu.",
];
